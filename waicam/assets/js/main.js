...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const waveReplaySelector = '.home-posthero-wave, .home-impact-wave, .home-newsletter-gwc__wave-divider, .home-bigstat-gwc__wave-divider, .home-news-grid-gwc__title-wave, .about-intro-gwc__wave, .about-gap-gwc__wave';
